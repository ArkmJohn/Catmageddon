...
public class PurrofileHandler : MonoBehaviour {
    ...
    // URLs please
    [SerializeField]
    private string _invupURL = "http://localhost/game/catmageddon/purripareinventory.php";
    [SerializeField]
    private string _sighnupURL = "http://localhost/game/catmageddon/catcreate.php";
    [SerializeField]
    private string _loginURL = "http://localhost/game/catmageddon/catnect.php";
    [SerializeField]
    private string _eCheckURL = "http://localhost/game/catmageddon/emailcheck.php";
